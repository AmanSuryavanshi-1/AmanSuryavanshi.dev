...
export default function ProjectsFilter({
    ...
    return (
        <div className="w-full mb-12 space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4">
                {categories.map((category) => (
                    <button
                        ...
                        className={cn(
                            "relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 capitalize",
            ...
            {/* Tech Filter Dropdown (Mobile/Desktop) */}
            <div className="flex justify-center">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="center" className="w-56 max-h-[300px] overflow-y-auto bg-white/90 backdrop-blur-md border-forest-100 p-2 rounded-xl shadow-xl">
