...
export const GithubCalendarComponent: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto text-center">
      ...
      >
        My <span className="text-lime-600">GitHub</span> Contributions
      </motion.h2>
      ...
      <motion.div
        ...
        className="w-full"
      >
        <Card className="group h-full overflow-hidden rounded-3xl border border-white/60 bg-white/40 backdrop-blur-md transition-all duration-300 shadow-xl hover:shadow-2xl hover:bg-white/60">
          <CardContent className="p-8">
            <div className="flex items-center justify-center w-full gap-4 mb-8">
              <div className="p-3 rounded-xl bg-forest-900/5 text-forest-900 group-hover:bg-lime-500 group-hover:text-white transition-colors duration-300">
                <Calendar className="w-6 h-6" />
              </div>
              <h3 className="text-2xl font-bold text-forest-900 group-hover:text-lime-600 transition-colors duration-300">
                Contribution Landscape
              </h3>
            </div>

            <div className="w-full overflow-x-auto flex justify-center items-center py-6">
              <div className="flex justify-center min-w-fit text-forest-900">
                <GitHubCalendar
            ...
            <p className="text-sm text-forest-700 mt-6 max-w-4xl mx-auto text-center leading-relaxed">
