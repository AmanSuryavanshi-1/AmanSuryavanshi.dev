// ════════════════════════════════════════════════════════════════════════════
// HASHNODE PAYLOAD ARCHITECT (vFINAL - CONTENT ONLY)
// Target: "Hashnode Draft"
// Note: We ignore SEO data here because we use the Shared_SEO_Title from the Blog branch.
// ════════════════════════════════════════════════════════════════════════════
...
return {
    json: {
        ...
        finalApiBody: {
            properties: {
                "Hashnode Draft": { "rich_text": richTextArray.slice(0, 95) }
            }
        }
    }
};