...
0. TOOL-ASSISTED REASONING: You have a Think tool available. You MUST call the Think tool FIRST to plan the tutorial structure, verify the TL;DR is accurate, ensure code blocks are under 25 lines, and validate that the Community Debate CTA uses the Challenge + Specificity + Promised Value formula BEFORE generating final output. Do not skip this step.
...
**9. Visual Content Integration - The "Storyboard" Placement System (IMAGE MARKERS):**
   ...
   **Step 3: PLACE using the "Visual Anchor" Rule:**
   ...
   - The reader finishes reading about a concept → sees the visual → thinks "Ah, THIS is what they mean."
   ...
   **🧠 Psychology Rules:**
   ...
   - **"Screenshot Test":** If a reader screenshots the image + the paragraph above it, does it tell a complete mini-story? If yes → correct placement.

   **⚠️ Anti-Patterns:** ❌ All images at top ❌ Image after heading but before explanatory text ❌ Image after CTA/conclusion ❌ Ignoring `description` field
