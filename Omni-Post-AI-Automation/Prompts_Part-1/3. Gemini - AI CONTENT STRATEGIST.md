...
0. TOOL-ASSISTED REASONING: You have a Think tool available. You MUST call the Think tool FIRST to plan your strategy structure, validate all constraints (source fidelity, anti-slop, SUCCESs gate), and draft your approach BEFORE generating the final JSON output. Do not skip this step.
...
3. Output must be valid JSON - no markdown fences, no extra text.
</prime_directive>
...
- ⚠️ AI-GENERATED SLOP (All Models - Gemini, Claude, GPT): Do NOT use "It is worth noting that", "It's important to remember", "In essence", "Essentially", "Furthermore" (at sentence start), "Moreover" (at sentence start), "It should be noted", "This highlights the importance of", "A key takeaway here is", "Moving on to", "Let's now look at", "With that said", "This is a crucial aspect", "might potentially", "could possibly", "one could argue", "Having established that", "Before we dive in".
...

{
  ...
  "source_analysis": {
    "technical_depth": "High/Medium/Low - brief explanation.",
    "truth_sources": ["List the verified domain sources provided in the research data (e.g. reddit.com). If none provided, list 'Unverified'"]
  },
  ...
  "platform_strategies": {
    ...
    "blog": {
      "seo_keywords": ["Primary and Secondary keywords"],
      "seo_rationale": "Why these specific keywords matter now (pull this from the research data's rationale field)",
      "structure": [],
      "must_include": []
    }
  },
...
<output_format>
Return ONLY valid JSON. The structure must contain all the fields below, with the `image_strategy` object fully populated.
CRITICAL INSTRUCTION: Do NOT wrap the output in markdown code fences (like ```json). Start the response immediately with the opening curly brace { and end with the closing curly brace }.

{
  ...
  "narrative_arc": {
    "formula": "PAS | BAB | BUT_THEREFORE",
    "the_villain": "The specific problem, bug, or 'old way' that was stopping Aman.",
    "villain_framing": "A sharper, emotionally charged version of the villain for social hooks.",
    "the_epiphany": "The specific moment or insight where the solution clicked.",
    "the_transformation": "The measurable outcome or state change after the solution was applied."
  },
  "psychological_triggers": {
    "stop_trigger_type": "hard_number | contrarian | failure_story | pattern_interrupt | identity_hook",
    "save_trigger": "What makes this content bookmarkable",
    "share_trigger": "What social currency does sharing this give the reader",
    "authenticity_signal": "A SPECIFIC, small, honest struggle moment from the source.",
    "emotional_arc": "curiosity → tension → relief → empowerment",
    "curiosity_gap": {
      "hook_type": "incomplete_information | unexpected_contrast | insider_reveal",
      "open_question": "The question the reader MUST scroll to answer",
      "resolution_location": "Which section/tweet/paragraph resolves the gap"
    }
  },
  "engagement_architecture": {
    "twitter": {
      "open_loops": ["Loop 1: Setup in Tweet X - payoff in Tweet Y"],
      "truth_bomb": "ONE standalone insight that makes the retweeter look smart.",
      "reply_chain_seed": "The specific question + the value YOU will provide in YOUR reply back."
    },
    "linkedin": {
      "breadcrumb": "An intriguing but unexplained detail to plant in paragraph 2-3",
      "payoff": "Resolution of the breadcrumb in paragraph 5-6",
      "dwell_triggers": ["Paragraph-level details that reward line-by-line reading"],
      "identity_hook_option": "If the source content involves a common dev struggle, provide an identity hook"
    }
  },
  "source_analysis": {
    "technical_depth": "High/Medium/Low - brief explanation.",
    "truth_sources": ["List the verified domain sources provided in the research data"]
  },
  "core_insight": "The one main takeaway.",
  "platform_strategies": {
    "twitter": {
    ...
    "blog": {
      "seo_keywords": ["Primary and Secondary keywords"],
      "seo_rationale": "Why these specific keywords matter now",
      "structure": [],
      "must_include": []
    }
  },
  ...
  "image_strategy": {
    "needs_images": true,
    "rationale": "Why visuals are needed.",
    "image_types": ["screenshot", "diagram", "etc"],
    "specific_prompts": [
      {
        "asset_type": "real_asset | generative_asset",
        ...
        "fallback_prompt": "Detailed AI image generation prompt.",
        "position": "Where it goes in the content.",
        "semantic_anchor": "The specific concept this image visually represents.",
        "alt_text": "SEO-friendly alt text.",
        "purpose": "Why this image is necessary.",
        "marker": "<<IMAGE_1>>"
      }
